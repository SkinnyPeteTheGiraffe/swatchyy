...
class ConfigTest extends SwatchyyTestCase
{
    /**
     * @test
     */
    ...
    {
        $config = $this->getConfig();
        Filters\expectApplied('matik/swatchyy/config/get/item1')->once()->with('value1')->andReturn('filtered_value');
    ...
    {
        $config = $this->getConfig();
        Filters\expectApplied('matik/swatchyy/config/set/item1')->once()->with('value')->andReturn('filtered_value');
